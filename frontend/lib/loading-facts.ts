export const LOADING_FACTS: string[] = [
  ...
  'Google AI Overview — это AI-блок в поисковой выдаче Google. Он использует те же сигналы доверия, что и обычный SEO, плюс цитируемость в авторитетных источниках.',
  ...
  'AI-блок в Яндекс-выдаче и Алиса используют одни и те же источники — Яндекс.Справочник важно держать актуальным.',
